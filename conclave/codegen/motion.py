...
from conclave.job import MotionJob


class MotionCodeGen(CodeGen):
    """
    Codegen subclass for generating MOTION code.
    """
    ...
    def __init__(self, config: CodeGenConfig, dag: Dag, pid: int,
        ...
        self.mo_config = config.system_configs['motion']
        self.create_params = {}

        super(MotionCodeGen, self).__init__(config, dag)
